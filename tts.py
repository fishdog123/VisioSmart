...
def speak(text):
    ...
    try:
        # Clean up any leftover audio artifact safely
        ...
        # Let Piper natively generate the complete WAV file structure
        with wave.open(OUTPUT_WAV, "wb") as wav_file:
            voice.synthesize_wav(text, wav_file)

        # Quick verification check on the file asset
        ...
        # Play the track natively using the OS audio server
        with audio_lock:
            try:
